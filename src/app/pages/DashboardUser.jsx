...
import { BsArrowUpRightCircleFill, BsBarChartLine, BsBoxArrowInUpRight, BsBullseye, BsCalendar, BsCameraVideo, BsClock, BsEye, BsFileEarmarkText, BsHeart, BsImage, BsLightningCharge, BsPieChart, BsPlus, BsShare } from 'react-icons/bs'
                ...
                <section>
                    <div className="flex items-center justify-between gap-6">
                        <div className="flex flex-col gap-2">
                            <h1 className="text-3xl font-bold">Bienvenue, Alexandre</h1>
                            <p>Créez des campagnes marketing complètes en moins d'une minute grâce à l'IA</p>
                        </div>
                        <div>
                            <Button color="blue">
                        ...
                        <Card styles={"shadow-lg"}>
                            <div className="flex items-center justify-between gap-2">
                                <div className="flex flex-col gap-1">
                                    <span className="text-gray-500">Total campagnes</span>
                                    <span className="text-3xl font-bold">12</span>
                                    <span className="text-">+20% ce mois</span>
                                </div>
                        ...
                        <Card styles={"shadow-lg"}>
                            <div className="flex items-center justify-between gap-2">
                                <div className="flex flex-col gap-1">
                                    ...
                                    <span className="text-3xl font-bold">24.8K</span>
                                    <span className="text-">+15% ce mois</span>
                                </div>
                                <BsEye size={32} />
                            </div>
                        </Card>
                        <Card styles={"shadow-lg"}>
                            <div className="flex items-center justify-between gap-2">
                                <div className="flex flex-col gap-1">
                                    ...
                                    <span className="text-">+5% ce mois</span>
                                </div>
                                <BsHeart size={32} />
                            </div>
                        </Card>
                        <Card styles={"shadow-lg"}>
                            <div className="flex items-center justify-between gap-2">
                                <div className="flex flex-col gap-1">
                                    ...
                                    <span className="text-">+8% ce mois</span>
                                </div>
                                <BsBullseye size={32} />
                            </div>
                        </Card>
                    ...
                    <div className="grid grid-cols-6 items-start gap-6">
                                    ...
                                    <ul className="space-y-4">
                                            ...
                                            <Card styles={"w-full rounded-xl space-y-2"}>
                                                <div className="flex items-center justify-between gap-6">
                                                    <div className="flex items-center gap-2">
                                                        <h5 className="text-xl font-bold">Lancement Produit SaaS B2B</h5>
                                                        <Tag color="green">
                                                            Terminé
                                                        </Tag>
                                                    </div>
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-2 text-gray-500">
                                                        <BsCalendar />
                                                        <span>dimanche 14 juillet 2024</span>
                                                    </div>
                                                </div>
                                        ...
                                        <li className="flex items-center justify-between">
                                            <Card styles={"w-full rounded-xl space-y-2"}>
                                                <div className="flex items-center justify-between gap-6">
                                                    <div className="flex items-center gap-2">
                                                        <h5 className="text-xl font-bold">Campagne Formation IA</h5>
                                                        <Tag color="green">
                                                            Terminé
                                                        </Tag>
                                                    </div>
                        ...
                        <div className="col-span-2 grid grid-cols-1 gap-6">
                            <Card styles={"shadow-lg"}>
                                <div className="flex items-center gap-3">
                                    <BsPieChart size={18} />
                                    <h2 className="text-xl font-bold">Quota utilisé</h2>
                                </div>
                                <div className="mt-4">
                                    <div className="flex items-center justify-between gap-2">
                                        <span>Campagnes</span>
                            ...
                            <Card styles={"shadow-lg space-y-4 opacity-75"}>
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                ...
                                <div className="bg-gray-600/5 text-center space-y-2 p-4 rounded-lg">
                                    <p className="text-gray-400">Fonctionnalité disponible en version Pro</p>
