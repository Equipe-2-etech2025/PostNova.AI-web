    ...
    <div className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      <div className="bg-white shadow-md rounded-lg overflow-hidden">
        <div className="bg-gray-700 text-white px-6 py-4">
          ...
          <p className="text-gray-400 mt-1">Dernière mise à jour : {new Date().toLocaleDateString()}</p>
        </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <section className="border-b border-gray-200 pb-6">
            <h2 className="text-xl font-semibold text-gray-800 mb-3">3. Protection des données</h2>
            <p className="text-gray-600 mb-3">
          ...
          <section>
            ...
            <p className="text-gray-600 mb-3">
              Conformément au RGPD et autres lois sur la protection des données, vous avez le droit de :
            </p>
            <ul className="list-disc pl-5 space-y-2 text-gray-600">
