...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setCampaigns([
        { id: 1, name: 'Campagne été 2024', status: 'active' },
        { id: 2, name: 'Lancement produit', status: 'draft' },
      ]);
      setLoading(false);
    }, 1000);
  }, []);
  ...
  return (
    <div className="min-h-screen bg-[#1c1b23] text-white">
      ...
      <header className="bg-[#2e2d3b] p-4 flex justify-between items-center">
        <h1 className="text-2xl font-bold">PostNova.AI</h1>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-[#2e2d3b] rounded-lg p-6">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-xl font-semibold">Mes Campagnes</h3>
            ...
            {campaigns.length > 0 ? (
              <div className="space-y-4">
                {campaigns.map(campaign => (
                  <div key={campaign.id} className="flex justify-between items-center p-4 bg-[#1c1b23] rounded-lg">
                    <div>
              ...
              <div className="text-center py-8 text-gray-400">
                ...
                <Button className="mt-4">Créer votre première campagne</Button>
              </div>
            )}
          </div>
        </div>
