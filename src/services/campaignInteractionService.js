...
export const campaignInteractionService = {
    ...
    async updateInteraction(id, interactionData) {
        try {
            const response = await api.put(`/campaign-interactions/${id}`, interactionData);
            return {
                success: true,
                data: response.data,
    ...
    async getInteractionsByCampaignId(campaignId) {
        try {
            const response = await api.get(`/campaign-interactions/campaign/${campaignId}`);
            return {
                success: true,
                data: response.data,
            };
    ...
    async getCampaignStats(campaignId) {
        try {
            const response = await api.get(`/campaign-interactions/campaign/${campaignId}/stats`);
            return {
                success: true,
                data: response.data,
            };
    ...
    async addLike(interactionId) {
        try {
            const response = await api.post(`/campaign-interactions/${interactionId}/like`);
            return {
                success: true,
                data: response.data,
    ...
    async getInteractionsByCriteria(criteria = {}) {
        try {
            ...
            const response = await api.get(`/campaign-interactions/criteria?${queryString}`);
            return {
                success: true,
                data: response.data,
            };
